...
Criei este projeto para praticar TypeScript aplicando conceitos de suporte técnico, automação e APIs REST a um problema próximo da minha rotina: receber uma solicitação, organizar as informações e indicar o melhor encaminhamento.
